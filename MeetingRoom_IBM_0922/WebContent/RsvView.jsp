...
function popup(frm)
{
	...
	//winObject.opener.document.frm.start_dt.value = $("#date").val();
                  ...
                  <div>
                     <div class="well well-lg col-md-12" role="register">
                        ...
                        <div class="row">
                           ...
                           <!-- 예약 버튼 -->
						<div id="register">
						<button type="button" value="Click" class="btn btn-primary" onClick="popup(this.form);">클릭</button>
