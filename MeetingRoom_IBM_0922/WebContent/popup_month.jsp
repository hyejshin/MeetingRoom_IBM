...
function closeMe() {
	...
	var input = document.frm;
		...
		if (selected === "일") {
			input.action = "RsvEveryMonth.do";
		} else {
			input.action = "RsvEveryMonthByDay.do";
		}
...
<body>
<form name="frm" method="post" action="RsvEveryMonth.do">
...
<center>반복주기 : 
	<select id = "frequency" onchange="everymonth();">
		<option value="매주">매주</option>
		<option value="매월" selected="selected">매월</option>
	</select>
</center><br>

<center>일/요일 :
	<select id="dayFormat" name="dayFormat">
		<option value="date">일</option><option value="day" selected="selected">요일</option>
...
<center>종료일 : <input type="radio" name="rd" value="repeat" onChange="selectRadio();">계속반복<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  <input type="radio" name="rd" value="end_dt" onChange="selectRadio();">종료날짜 
